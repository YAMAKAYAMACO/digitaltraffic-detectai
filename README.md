...
<svg width="800" height="200" viewBox="0 0 800 200" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="96" y="42" font-family="'Courier New', monospace" font-size="11" fill="#e63946" text-anchor="middle" letter-spacing="1">CLAUDE SKILL v3.0</text>
  ...
  <text x="30" y="128" font-family="'Courier New', monospace" font-size="13" fill="#666666" letter-spacing="0.5">Очеловечить текст и убрать признаки ИИ. 56 паттернов на русском.</text>
  <rect x="30" y="152" width="96" height="26" rx="5" fill="#1a1a2e" stroke="#333355" stroke-width="1"/>
  <text x="78" y="169" font-family="'Courier New', monospace" font-size="11" fill="#8888bb" text-anchor="middle">56 паттернов</text>
...
[![Version](https://img.shields.io/badge/version-3.0.0-e63946?style=flat-square)]()
...
> **Claude skill (гуманизатор текста)**, который помогает **очеловечить текст** и **убрать признаки ИИ из текста** на русском языке — бесплатно. Возвращает живой голос автора: без воды, без «важно отметить», без «данного подхода». 56 паттернов на основе реальных наблюдений за тем, как русскоязычные LLM портят тексты. Подходит, чтобы очеловечить текст, написанный ИИ (ChatGPT, нейросети): для статей, постов, дипломов, курсовых и коммерческих текстов.
...
**Как очеловечить текст, написанный ИИ?**

Установи скилл (см. [Установка](#установка)) и напиши Claude «очеловечь текст» или «убери ИИ», вставив текст. Скилл в два прохода уберёт признаки ИИ и вернёт живой человеческий голос.

**Это бесплатно?**

Да, полностью бесплатно, лицензия MIT. Нужен только доступ к Claude.

**Чем отличается от простого промпта «перепиши по-человечески»?**

Обычный промпт убирает самые заметные клише, но оставляет десятки скрытых паттернов — одинаковый ритм предложений, пассивный залог, отсутствие позиции. Скилл работает по 56 конкретным правилам с двойным проходом и финальным аудитом («ИИ-балл»).
...
**Подходит для диплома, курсовой, ВКР?**

Да. В скилле есть отдельный блок для учебных и научных текстов: он убирает ИИ-паттерны (воду, «важно отметить», симметрию), но сохраняет научный стиль, терминологию и ссылки.

**Поможет пройти детектор ИИ / антиплагиат?**

Детекторы ИИ и антиплагиат — вероятностные инструменты. Скилл делает текст живее и человечнее, что снижает «ИИ-балл» и вероятность срабатывания детектора, но 100% гарантии нет. Цель — качество текста, а не обман проверки.
...
### v3.0.0 — июль 2026
- 56 паттернов вместо 40 (+16 новых: грандиозные зачины, скрытые конструкции ИИ, оформление постов)
- Отдельный блок для учебных и научных текстов (диплом, курсовая, ВКР, статья)
- Добавлен финальный «ИИ-балл» (оценка текста 0–10)
